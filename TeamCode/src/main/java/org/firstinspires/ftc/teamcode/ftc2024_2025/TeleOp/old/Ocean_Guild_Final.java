...
@Disabled
@TeleOp(name = "Ocean Guild Final")
public class Ocean_Guild_Final extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                ...
                */
                        ...
                        double v1 = r * Math.cos(robotAngle) + rightX * 0.65; //lf
                        double v2 = r * Math.sin(robotAngle) + rightX * 0.65; //rf
                        double v3 = r * Math.sin(robotAngle) - rightX * 0.65; //lb
                        double v4 = r * Math.cos(robotAngle) - rightX * 0.65; //rb
